...
description: >-
  Analyze raw prompts, identify intent and gaps, match SkillLord components
...
Analyze a draft prompt, critique it, match it to SkillLord components,
...
- User says "how should I use SkillLord for..."
...
- User is asking about SkillLord configuration (use `configure-skilllord` instead)
...
Map intent + scope + tech stack (from Phase 0) to specific SkillLord components.
...
- "Optimize this prompt for SkillLord"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt SkillLord for this task?"
...
|-----------|------------------|
| `configure-skilllord` | User hasn't set up SkillLord yet |
