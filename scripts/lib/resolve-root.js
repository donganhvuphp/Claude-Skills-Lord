...
/**
 * Resolve the SkillLord plugin root directory.
 *
 * Tries, in order:
 ...
 *   3. Plugin cache auto-detection — scans ~/.claude/plugins/cache/skilllord/
 ...
 *                                    contains plugin scripts. Default: 'scripts/lib/utils.js'
...
function resolveRoot(options = {}) {
  ...
  try {
    const cacheBase = path.join(claudeDir, 'plugins', 'cache', 'skilllord');
 ...
 *
 * This is the minified form of resolveRoot() suitable for use in
